...
interface SchemaDumpOptions {
     ...
     * - Objeto: inclui views e aplica as opções (createOrReplace, definer, etc.).
...
interface DumpOptions {
    ...
    /**
     * Lista opcional de views a incluir no dump, na ordem desejada.
     * Mesmo padrão de `tables`: define quais views incluir e a ordem de criação (útil quando views dependem umas das outras).
     * Se não informado ou vazio, todas as views são incluídas na ordem retornada pelo banco.
     */
    views?: Array<string>;
    /**
